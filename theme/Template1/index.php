    ...
    <div class="panel1">
        ...
        <div class="menu">
            ...
            <div style="padding-bottom:10px;"></div>
             ...
             <p style="padding-top:10px;padding-right:20px;padding-bottom:10px;font-family:BYekan;"><?= post_title(); ?></p>
             <div style="width:95%;height:3px;background:#15E31E;margin:auto;"></div>
             <div style="width:500px;margin:50px auto;"><img src="<?= get_template_uri(); ?>images/yii.jpg" style="width:500px;"></div>
             <div class="post_text">
                 <?= post_content(); ?>
             </div>
